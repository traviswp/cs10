...
public class EditDistance {
     ...
     * 1) Insert a character 2) Delete a character 3) Replace a character 4)
     * Twiddle (Swap two characters to match the output).
     * 
    ...
    /**
     * A helper function for memoizedEditDistance that uses a Map to keep track
