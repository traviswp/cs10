...
public class AdjacencyListGraph<V, E> implements Graph<V, E> {
    ...
    /**
     * Replace the element a given position (vertex or edge) with a new element
     * and return the old element
     * 
     * @param p
     *            the position (vertex or edge) to be updated
     * @param o
     *            the new value
     */
     ...
     * 
     * @param e
     *            the edge whose end vertices are to be returned
     ...
     *            the vertex
     * @param e
     *            the edge to find the opposite end of
     ...
     * 
     * @param e
     *            the edge to check for validity
     ...
     * 
     * @return string represention of vertex list and edge list, separated by a
     *         newline.
     */
     ...
     * vertex stores its incidence container and position in the vertex
    ...
    protected class MyVertex<V> extends MyPosition<V> implements Vertex<V> {
         ...
         * 
         * @param p
         *            the edge-containing position to remove from its container
         */
        ...
        /**
         * Returns the position of this vertex in the vertex container of the
         * graph.
         * 
         * @return the position
         */
        ...
        /**
         * Sets the position of this vertex in the vertex container of the
         * graph.
         * 
         * @param the
         *            new value of the position of this vertex
         */
    ...
    /**
     * Implementation of an edge for an undirected adjacency list graph. Each
     * edge stores its endpoints (end vertices), its positions within the
     * incidence containers of its endpoints, and position in the edge container
     * of the graph.
     */
    protected class MyEdge<E> extends MyPosition<E> implements Edge<E> {
        ...
        /**
         * The positions of the entries for the edge in the incidence containers
         * of the end vertices.
         */
        ...
        /**
         * Returns the end vertices of the edge. There are always two elements
        ...
        /**
         * Returns the positions of the edge in the incidence containers of its
         * end vertices. The returned array always contains two elements.
         * 
         * @return the positions of the edge in the incidence containers of its
         *         end vertices.
         */
        ...
        /**
         * Sets the positions of the edge in the incidence containers of its end
         * vertices.
         * 
         * @param pv
         ...
         * 
         * @param p
         *            the new value for the position of this edge
         */
         ...
         */
        public String toString() {
            return element() + "(" + endVertices[0].toString() + ","  + endVertices[1].toString() + ")";
        }
    }
}
