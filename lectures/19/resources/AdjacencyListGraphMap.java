...
/**
 * An realization of a graph according to adjacency list structure. Modified to
 * use a map from vertex names to vertices instead of a NodePositionList to hold
 * the vertices. Assumes that vertex values are unique.
 *
...
public class AdjacencyListGraphMap<V,E> implements Graph<V,E> {
	 ...
	 */
	public Vertex<V> insertVertex(V v) throws InvalidKeyException {
	 ...
	 */
	public Edge<E> insertEdge(V v, V w, E o) throws InvalidPositionException {
	 ...
	 */
	public Iterable<Edge<E>> incidentEdges(V v) throws InvalidPositionException {
	 ...
	 */
	public Vertex<V> opposite(V v, Edge<E> e) throws InvalidPositionException {
	 ...
	 */
	public V replace(Vertex<V> v, V o) throws InvalidPositionException, InvalidKeyException {
		V temp = v.element();
		MyVertex<V> vv = checkVertex(v);
		vv.setElement(o);
	...
	public static void main(String [] args) {
		...
		System.out.println("\nDegree of Kevin Bacon = " + baconGraph.degree("Kevin Bacon"));
		...
		System.out.println("\nGetting Laura Linney: " + baconGraph.getVertex("Laura Linney"));
