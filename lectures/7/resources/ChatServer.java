...
public class ChatServer {
	...
	public static void main(String[] args) throws Exception {
        ...
        System.out.println("ChatServer's IP Address INSIDE of the current network : " + MyIPAddressHelper.getMyLocalIP());
        System.out.println("ChatServer's IP Address OUTSIDE of the current network: " + MyIPAddressHelper.getMyGlobalIP());

        System.out.println("ChatServer: waiting for connections");
