...
* Outline
{:toc}
# January 21: Cient/Server #

<a href="../6/6.html">[prev]</a>
<a href="../8/8.html">[next]</a> 
...
* <a href="#socket">Sockets</a> [Java tutorials on <a href="http://docs.oracle.com/javase/tutorial/networking/sockets">sockets</a>]
* <a href="#server">Server</a>
* <a href="#multi">Multithreaded server</a> [Java tutorials on <a href="http://docs.oracle.com/javase/tutorial/essential/concurrency/procthread.html">threads</a>]
* <a href="#chat">Chat server</a> [Java tutorials on <a href="http://docs.oracle.com/javase/tutorial/essential/concurrency/syncmeth.html">synchronized methods</a>]
...
<a name="multi"></a><h2>Multithreaded server</h2>
...
<a name="chat"></a><h2>Chat server</h2>
