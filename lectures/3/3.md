...
<p>We have to tell Java what to do when it notices some such event. This is handled by a listener object that provides an appropriate method to invoke with the event. An example:</p>
