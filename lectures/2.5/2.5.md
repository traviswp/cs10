...
"When a veriable of a class is declared as *static*, its value is associated with
...
**NOTE:** "Static variables for a class exist even if no instance of their
class exists."
...
Unfortunately, that is not the way it works.  Show examples from <code>Counter</code>.</p>
